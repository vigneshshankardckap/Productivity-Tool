        ...
        <main class="page-content">
          <div class="card">
            <div class="content">
              ...
              <?php foreach($fetchAllDataDo as $do): ?>
    ...
    <div class="single-input-form">
      ...
      <div class="matix">
        ...
        <div class="ImportantDiv">
          ...
          <br />
          <input type="button" name="important-priority-btn" value="1" id="firstFrom"
            class="important-priority-btn datas" />
          <input type="button" name="important-priority-btn" value="0" id="firstFrom"
            class="important-priority-btn datas" />
        </div>
      </div>
